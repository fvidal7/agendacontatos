	...
	<div class="container mt-4">
		<div class="card">
			<div class="card-body">
				...
				<p>Utilize os campos para alterar os dados do contato em sua
					agenda.</p>
				<hr />
					...
					<div class="row mb-2">
						...
						<div class="col-md-3">
							<label>Tipo do contato:</label> <select name="tipo" id="tipo"
								...
								<option value="3"
									${contato.tipo == 'TRABALHO' ? "selected" : ""}>Trabalho</option>
					...
					<div class="row mb-2">
						<div class="col-md-12">
							<input type="submit" class="btn btn-primary"
								...
								href="/projetoweb01/admin/consultarcontatos"
								class="btn btn-light"> Voltar para consulta </a>
						</div>
					</div>
